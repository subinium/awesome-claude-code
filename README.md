...
| [sunnja69/akephalos](https://github.com/sunnja69/akephalos) | ![](https://img.shields.io/github/stars/sunnja69/akephalos?style=flat-square&logo=github) | Early local-first `.akephalos` passport and MCP stdio server for portable agent preferences, tool notes, rules, project context, and durable memories via markdown/plain files + Git. |
