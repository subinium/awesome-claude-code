...
| [MohamedAbdallah-14/unslop](https://github.com/MohamedAbdallah-14/unslop) | ![](https://img.shields.io/github/stars/MohamedAbdallah-14/unslop?style=flat-square&logo=github) | Claude Code plugin + CLI that strips AI writing patterns (sycophancy, stock vocab, hedging) before publishing |
...
| [MohamedAbdallah-14/prompt-to-asset](https://github.com/MohamedAbdallah-14/prompt-to-asset) | ![](https://img.shields.io/github/stars/MohamedAbdallah-14/prompt-to-asset?style=flat-square&logo=github) | MCP server generating production-ready visual assets (icons, favicons, OG images) across 30+ image generation models |
